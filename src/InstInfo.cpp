...
InstInfo *InstInfo::Syntax_DIR_IDX_IMM8_EXT(
	const String &symbol, UInt8 codeDIR, UInt8 codeIDX, UInt8 codeIMM8, UInt8 codeEXT)
{
	InstInfo *pInstInfo = new InstInfo(symbol, "DIR_IDX_IMM8_EXT");
	pInstInfo->AddRule(new InstInfo::Rule_DIR(codeDIR));
	pInstInfo->AddRule(new InstInfo::Rule_IDX(codeIDX));
	pInstInfo->AddRule(new InstInfo::Rule_IMM8(codeIMM8));
	pInstInfo->AddRule(new InstInfo::Rule_EXT(codeEXT));
	return pInstInfo;
}

InstInfo *InstInfo::Syntax_DIR_IDX_IMM16_EXT(
	const String &symbol, UInt8 codeDIR, UInt8 codeIDX, UInt8 codeIMM16, UInt8 codeEXT)
{
	InstInfo *pInstInfo = new InstInfo(symbol, "DIR_IDX_IMM16_EXT");
	pInstInfo->AddRule(new InstInfo::Rule_DIR(codeDIR));
	pInstInfo->AddRule(new InstInfo::Rule_IDX(codeIDX));
	pInstInfo->AddRule(new InstInfo::Rule_IMM16(codeIMM16));
	pInstInfo->AddRule(new InstInfo::Rule_EXT(codeEXT));
	return pInstInfo;
}
...
InstInfo *InstInfo::Syntax_IMM8_DIR_IDX_EXT(
	const String &symbol, UInt8 codeIMM8, UInt8 codeDIR, UInt8 codeIDX, UInt8 codeEXT)
{
	InstInfo *pInstInfo = new InstInfo(symbol, "IMM8_DIR_IDX_EXT");
	pInstInfo->AddRule(new InstInfo::Rule_IMM8(codeIMM8));
	pInstInfo->AddRule(new InstInfo::Rule_DIR(codeDIR));
	pInstInfo->AddRule(new InstInfo::Rule_IDX(codeIDX));
	pInstInfo->AddRule(new InstInfo::Rule_EXT(codeEXT));
...
InstInfo *InstInfo::Syntax_AxB_IMM8_DIR_IDX_EXT(
	const String &symbol,
...
{
	InstInfo *pInstInfo = new InstInfo(symbol, "AxB_IMM8_DIR_IDX_EXT");
	pInstInfo->AddRule(new InstInfo::Rule_IMM8(codeIMM8_A, "a"));
	pInstInfo->AddRule(new InstInfo::Rule_DIR(codeDIR_A, "a"));
	pInstInfo->AddRule(new InstInfo::Rule_IDX(codeIDX_A, "a"));
	pInstInfo->AddRule(new InstInfo::Rule_EXT(codeEXT_A, "a"));
	pInstInfo->AddRule(new InstInfo::Rule_IMM8(codeIMM8_B, "b"));
	pInstInfo->AddRule(new InstInfo::Rule_DIR(codeDIR_B, "b"));
	pInstInfo->AddRule(new InstInfo::Rule_IDX(codeIDX_B, "b"));
	pInstInfo->AddRule(new InstInfo::Rule_EXT(codeEXT_B, "b"));
	return pInstInfo;
...
void InstInfoMap::Initialize()
{
	...
	Add(InstInfo::Syntax_AxB_IMM8_DIR_IDX_EXT	("adc", 0x89, 0x99, 0xa9, 0xb9, 0xc9, 0xd9, 0xe9, 0xf9));
	Add(InstInfo::Syntax_IMM8_DIR_IDX_EXT		("adca", 0x89, 0x99, 0xa9, 0xb9));
	Add(InstInfo::Syntax_IMM8_DIR_IDX_EXT		("adcb", 0xc9, 0xd9, 0xe9, 0xf9));
	Add(InstInfo::Syntax_AxB_IMM8_DIR_IDX_EXT	("add", 0x8b, 0x9b, 0xab, 0xbb, 0xcb, 0xdb, 0xeb, 0xfb));
	Add(InstInfo::Syntax_IMM8_DIR_IDX_EXT		("adda", 0x8b, 0x9b, 0xab, 0xbb));
	Add(InstInfo::Syntax_IMM8_DIR_IDX_EXT		("addb", 0xcb, 0xdb, 0xeb, 0xfb));
	Add(InstInfo::Syntax_AxB_IMM8_DIR_IDX_EXT	("and", 0x84, 0x94, 0xa4, 0xb4, 0xc4, 0xd4, 0xe4, 0xf4));
	Add(InstInfo::Syntax_IMM8_DIR_IDX_EXT		("anda", 0x84, 0x94, 0xa4, 0xb4));
	Add(InstInfo::Syntax_IMM8_DIR_IDX_EXT		("andb", 0xc4, 0xd4, 0xe4, 0xf4));
	...
	Add(InstInfo::Syntax_AxB_IMM8_DIR_IDX_EXT	("bit", 0x85, 0x95, 0xa5, 0xb5, 0xc5, 0xd5, 0xe5, 0xf5));
	Add(InstInfo::Syntax_IMM8_DIR_IDX_EXT		("bita", 0x85, 0x95, 0xa5, 0xb5));
	Add(InstInfo::Syntax_IMM8_DIR_IDX_EXT		("bitb", 0xc5, 0xd5, 0xe5, 0xf5));
	...
	Add(InstInfo::Syntax_AxB_IMM8_DIR_IDX_EXT	("cmp", 0x81, 0x91, 0xa1, 0xb1, 0xc1, 0xd1, 0xe1, 0xf1));
	Add(InstInfo::Syntax_IMM8_DIR_IDX_EXT		("cmpa", 0x81, 0x91, 0xa1, 0xb1));
	Add(InstInfo::Syntax_IMM8_DIR_IDX_EXT		("cmpb", 0xc1, 0xd1, 0xe1, 0xf1));
	...
	Add(InstInfo::Syntax_DIR_IDX_IMM16_EXT		("cpx", 0x9c, 0xac, 0x8c, 0xbc));
	...
	Add(InstInfo::Syntax_AxB_IMM8_DIR_IDX_EXT	("eor", 0x88, 0x98, 0xa8, 0xb8, 0xc8, 0xd8, 0xe8, 0xf8));
	Add(InstInfo::Syntax_IMM8_DIR_IDX_EXT		("eora", 0x88, 0x98, 0xa8, 0xb8));
	Add(InstInfo::Syntax_IMM8_DIR_IDX_EXT		("eorb", 0xc8, 0xd8, 0xe8, 0xf8));
	...
	Add(InstInfo::Syntax_AxB_IMM8_DIR_IDX_EXT	("lda", 0x86, 0x96, 0xa6, 0xb6, 0xc6, 0xd6, 0xe6, 0xf6));
	Add(InstInfo::Syntax_IMM8_DIR_IDX_EXT		("ldaa", 0x86, 0x96, 0xa6, 0xb6));
	Add(InstInfo::Syntax_IMM8_DIR_IDX_EXT		("ldab", 0xc6, 0xd6, 0xe6, 0xf6));
	Add(InstInfo::Syntax_DIR_IDX_IMM16_EXT		("lds", 0x9e, 0xae, 0x8e, 0xbe));
	Add(InstInfo::Syntax_DIR_IDX_IMM16_EXT		("ldx", 0xde, 0xee, 0xce, 0xfe));
	...
	Add(InstInfo::Syntax_AxB_IMM8_DIR_IDX_EXT	("ora", 0x8a, 0x9a, 0xaa, 0xba, 0xca, 0xda, 0xea, 0xfa));
	Add(InstInfo::Syntax_IMM8_DIR_IDX_EXT		("oraa", 0x8a, 0x9a, 0xaa, 0xba));
	Add(InstInfo::Syntax_IMM8_DIR_IDX_EXT		("orab", 0xca, 0xda, 0xea, 0xfa));
	...
	Add(InstInfo::Syntax_AxB_IMM8_DIR_IDX_EXT	("sbc", 0x82, 0x92, 0xa2, 0xb2, 0xc2, 0xd2, 0xe2, 0xf2));
	Add(InstInfo::Syntax_IMM8_DIR_IDX_EXT		("sbca", 0x82, 0x92, 0xa2, 0xb2));
	Add(InstInfo::Syntax_IMM8_DIR_IDX_EXT		("sbcb", 0xc2, 0xd2, 0xe2, 0xf2));
	...
	Add(InstInfo::Syntax_AxB_IMM8_DIR_IDX_EXT	("sub", 0x80, 0x90, 0xa0, 0xb0, 0xc0, 0xd0, 0xe0, 0xf0));
	Add(InstInfo::Syntax_IMM8_DIR_IDX_EXT		("suba", 0x80, 0x90, 0xa0, 0xb0));
	Add(InstInfo::Syntax_IMM8_DIR_IDX_EXT		("subb", 0xc0, 0xd0, 0xe0, 0xf0));
