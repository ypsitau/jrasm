...
public:
	...
	public:
		...
		virtual ~Rule();
		virtual bool Apply(Context &context, const Expr_Inst *pExpr, bool generateFlag, UInt32 *pBytes) = 0;
	};
	...
	public:
		...
		virtual bool Apply(Context &context, const Expr_Inst *pExpr, bool generateFlag, UInt32 *pBytes);
	};
