	...
	_pExprListResolved(new ExprList()), _pExprDictIncluded(new ExprDict())
{
	...
	_segmentOwner.push_back(new Segment("code", true, nullptr));// code segment
	_segmentOwner.push_back(new Segment("inline", true,			// inline data segment
										_segmentOwner.back()->Reference()));
	_segmentOwner.push_back(new Segment("data", true,			// data segment
										_segmentOwner.back()->Reference()));
	_segmentOwner.push_back(new Segment("work", false,			// work segment
										_segmentOwner.back()->Reference()));
