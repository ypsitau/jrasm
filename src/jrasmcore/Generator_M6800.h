...
public:
	...
	virtual Expr *DoComposeExpr_Save(Context &context, Expr *pExpr, const StringList &regNames) const;
	virtual Expr *DoComposeExpr_Restore(Context &context, Expr *pExpr,
										Directive_SAVE *pDirectiveSAVE, const StringList &regNames) const;
